...
def hospital_search_logic(search_input):
    tuples = []
    result = requests.get("https://www.googleapis.com/customsearch/v1?key=AIzaSyD8lesvuvvaM9NYaTipX2oDlDbMy1VKJbY&cx=f1a359b362d6cce63&q=hospitals near " + search_input)
